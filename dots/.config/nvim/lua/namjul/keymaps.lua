...
wk.add(
  ...
  { "<leader>vi", ":lua vim.cmd.VimuxInspectRunner", desc = "Vimux Inspect runner pane", nowait = false, remap = false },
  { "<leader>vl", ":lua vim.cmd.VimuxRunLastCommand", desc = "Run last command executed by VimuxRunCommand", nowait = false, remap = false },
  { "<leader>vp", ":lua vim.cmd.VimuxPromptCommand", desc = "Prompt for a command to run", nowait = false, remap = false },
  { "<leader>vz", ":lua vim.cmd.VimuxZoomRunner", desc = "Zoom the tmux runner pane", nowait = false, remap = false },
