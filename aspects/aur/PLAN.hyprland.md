# aspects/aur plan — Hyprland (archived)

> **Archived 2026-07-05.** Pivoting to Arch + Wayland + Sway (i3-compatible). See [PLAN.sway.md](PLAN.sway.md).
>
> Progress when archived: steps 1–5 complete in VM; step 6+ not started. `aspects/aur/packages` still installs `hyprland` / `xdg-desktop-portal-hyprland` — revert or swap when executing the Sway plan.
