...
> Source: https://github.com/juanibiapina/dotfiles/tree/6ebf41489c7228716e7a7d79fb5449e5583283c8/agents/skills/investigate/SKILL.md
> Imported from commit: `6ebf41489c7228716e7a7d79fb5449e5583283c8`
> License: MIT, Copyright (c) 2026 Juan Ibiapina

# Investigate

Find the cause with evidence. Investigation ends at a named cause. For read-only tracing without fixing, use the `causal` prompt instead.
