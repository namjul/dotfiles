...
nmap_leader('bj', '<Cmd>Write750<CR>', '750-word journal session')
...
nmap_leader('fp', '<Cmd>Pick projects<CR>', 'Personal projects')
...
nmap_leader('gL', '<Cmd>Gclog -- %<CR>', 'Open Git log')
nmap_leader('go', '<Cmd>lua MiniDiff.toggle_overlay()<CR>', 'Toggle Git diff hunk overlay')
nmap_leader('ga', '<Cmd>Git diff --cached<CR>', 'Show Git diff of staged changes')
nmap_leader('gs', '<Cmd>Git<CR>', 'Open Git status')
nmap_leader('gc', '<Cmd>Git commit -v<CR>', 'Create Git commit')
nmap_leader('gC', '<Cmd>Git commit --amend<CR>', 'Git amend')
nmap_leader('ga', '<Cmd>Git add -p<CR>', 'Git patch')
nmap_leader('gp', '<Cmd>Git push<CR>', 'Push Git changes to remote')
nmap_leader('gd', '<Cmd>Gdiff<CR>', 'Show Git diff for current file')
nmap_leader('gw', '<Cmd>Gwrite<CR>', 'Stage current file (Git add)')
nmap_leader('gbr', '<Cmd>GBrowse<CR>', 'Open file in Git remote (browser)')
nmap_leader('gx', '<Cmd>lua MiniGit.show_at_cursor()<CR>', 'Show Git info at cursor')
